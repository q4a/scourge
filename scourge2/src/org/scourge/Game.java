...
public abstract class Game extends BaseGame {
    ...
    protected FirstPersonHandler firstPersonHandler;
...
//        doDebug(r);
    ...
    protected void initSystem() throws JmeException {
        ...
        firstPersonHandler = new FirstPersonHandler( cam, 50, 1 );
...
//
    ...
    protected void cameraPerspective() {
        ...
        cam.setFrustumPerspective( 30.0f, (float) display.getWidth() / (float) display.getHeight(), 1, 1000 );
    ...
    protected void cameraParallel() {
        ...
        //float f = 50;
        float f = 35;
        cam.setFrustum( -100, 1000, -f * aspect, f * aspect, -f, f );
        cam.update();
    }
...
//      lgrapher = GraphFactory.makeTimedGraph((int)(lineGraph.getWidth()+.5f), (int)(lineGraph.getHeight()+.5f), lineGraph);
        ...
        lineGraph.setCullHint(Spatial.CullHint.Always);
        ...
        labGraph.setCullHint(Spatial.CullHint.Always);
