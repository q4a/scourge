...
If you placed the SDL framework in <Your Home Directory>/Library/Frameworks instead of /Library/Frameworks, you will need to use the -F flag to tell gcc where the Framework is located. Also remember to change the location for the -I parameter too. For example:

gcc -I/Users/ewing/Library/Frameworks/SDL.framework/Headers MyProgram.c SDLmain.m -F/Users/ewing/Library/Frameworks -framework SDL -framework Cocoa
