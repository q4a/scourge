/***************************************************************************
                    sqbinding.h  -  Squirrel binding - General
                             -------------------
...
public:
	...
	bool callIntAndStringArgMethod( const char *name, int argc, int *args, int argsc, char *argss[] );
	...
	inline static void setCurrentWeapon( Item *item ) {
		currentWeapon = item;
	}
	inline static Item *getCurrentWeapon() {
