...
/**
 * This generator generates a 300x300 (quarter) map. Before calling generate(), be sure to call setRegion().
 * 
 ...
 * 
 * A Map object can thus contain 4 300x300 map section (since it's 600x600 units large) which is the max number
 * of sections seen by the player at one time. (If the player reaches the corner of one 300x300 section.) 
 * 
